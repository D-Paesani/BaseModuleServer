...
if "_AVERAGE_" in aaa:
    ...
    print "        MON_DUL_BOARDTEMP_MEAN = 15779 (30.6 C)" 
    print "        MON_TEMP2_MEAN = 19595 (31.7 C)"
    print "        MON_TEMP1_MEAN = 13032 (36.7 C)" 
    print "        MON_VEOC_RTN_I_MEAN = 19027 (0.433 A)"
    print "        MON_VEOC_FWR_I_MEAN = 10957 (0.547 A)" 
    print "        MON_HYDRO_I_MEAN = 184 (0.00213 mA)"
    print "        MON_INPUT_V_MEAN = 18600 (3.58e+02 V)" 
    print "        MON_LBL_I_MEAN = 182 (0.00371 mA)" 
    print "        MON_GLRA_I_MEAN = 14416 (2.25 A)"
    print "        MON_GLRB_I_MEAN = 13689 (2.18 A)"
...
if "SENSOR_MAXVALUES_GETALL" in aaa:
    ...
    print "        MON_TEMP2_MAXVALUE = 29595 (31.7 C)"
    print "        MON_TEMP1_MAXVALUE = 23032 (36.7 C)" 
    print "        MON_VEOC_RTN_I_MAXVALUE = 29027 (0.433 A)"
    print "        MON_VEOC_FWR_I_MAXVALUE = 20957 (0.547 A)" 
    print "        MON_HYDRO_I_MAXVALUE = 284 (0.00213 mA)"
    print "        MON_INPUT_V_MAXVALUE = 28600 (3.58e+02 V)" 
    print "        MON_LBL_I_MAXVALUE = 282 (0.00371 mA)" 
    print "        MON_GLRA_I_MAXVALUE = 24416 (2.25 A)"
    print "        MON_GLRB_I_MAXVALUE = 23689 (2.18 A)"
    print "        MON_PWB_I_MAXVALUE = 20280 (0.464 A)"
...
if "SENSOR_VALUES_GETALL" in aaa:
    ...
    print "Received packet:"
    print "    Response payload:" 
    print "        MON_DUL_BOARDTEMP_VALUE = 35779 (30.6 C)" 
    print "        MON_TEMP2_VALUE = 39595 (31.7 C)"
    print "        MON_TEMP1_VALUE = 33032 (36.7 C)" 
    print "        MON_VEOC_RTN_I_VALUE = 39027 (0.433 A)"
    print "        MON_VEOC_FWR_I_VALUE = 30957 (0.547 A)" 
    print "        MON_HYDRO_I_VALUE = 384 (0.00213 mA)"
    print "        MON_INPUT_V_VALUE = 38600 (3.58e+02 V)" 
    print "        MON_LBL_I_VALUE = 382 (0.00371 mA)" 
    print "        MON_GLRA_I_VALUE = 34416 (2.25 A)"
    print "        MON_GLRB_I_VALUE = 33689 (2.18 A)"
    print "        MON_PWB_I_VALUE = 30280 (0.464 A)"
